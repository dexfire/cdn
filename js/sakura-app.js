  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/other/gravatar.jpg')
      } else {
        ele.src = 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/other/default_gavatar.jpg'
      break
    case 3:
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/themebg/sakura.png' || bgurl == 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/themebg/plaid.jpg' || bgurl == 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/themebg/star.png' || bgurl == 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/themebg/point.png' || bgurl == 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  changeBG('#KAdots-bg', 'https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/themebg/point.png')
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://cdn.jsdelivr.net/gh/dexfire/cdn@v1.0/images/other/starry_sky.png)')
